...
const AppHeader: React.FC = () => {
    ...
    return (
        <header className="sticky top-0 z-99999 flex w-full border-red-600 bg-[#084896]">
            <div className="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
                <div className="flex w-full items-center justify-between gap-2 px-3 py-3 sm:gap-4 lg:justify-normal lg:px-0 lg:py-4">
                    <button
                        className="z-99999 flex h-11 w-11 items-center justify-center rounded-lg bg-white"
